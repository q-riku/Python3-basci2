"""
    W3Cschool--Python进阶课程--点餐系统实战
"""
class OrderingFood:
    ordering_food_name = ['酸菜鱼','红烧排骨','红烧茄子','香肠套餐']
    ...
    def do_order_food(self):
        while True:
            ...
            if num=="1":
                print("-----------套餐清单-----------------")
                ordering_food_len = self.ordering_food_name.__len__()
                ...
                if food_index >= 0 and food_index < ordering_food_len:
                    ...
                    for each in self.order_list:
                        ...
                        food_name = self.ordering_food_name[food_index]
